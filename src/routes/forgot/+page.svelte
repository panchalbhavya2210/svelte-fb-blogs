<script>
  ...
  function sendLink() {
    ...
    sendPasswordResetEmail(auth, passRestMail)
      .then(() => {
        state = !state;
...
<main>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="">
        ...
        <div>
          ...
          >
            ...
            {state ? "Sending link..." : "Send link"}</button
          >
        </div>
      </form>
      ...
      <div class="relative">
        <div
          class="p-4 mb-4s text-sm text-green-800 rounded-lg bg-green-50 dark:bg-green-100 shadow-lg dark:text-green-900 absolute transition {successState
